...
\begin{tikzpicture}[
    ...
    \node[state, initial] (0) {};
    \node[state, above=1cm of 0] (1) {};
    \node[state, right=1cm of 1] (2) {};
    \node[state, right=1.5cm of 2] (3) {};
    \node[state, right=1.5cm of 3] (4) {};
    \node[state, right=1.5cm of 4] (5) {};
    \node[state, below=1.5cm of 5] (6) {};
    \node[state, accepting, left=2.5cm of 6] (7) {};
    \node[state, left=2.5cm of 7] (8) {};
